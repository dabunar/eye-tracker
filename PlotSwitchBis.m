function PlotSwitchBis(matrices,i )
...
m = 1: length(matrices{i});         % number of Runs in einem Subject
o = max(length(matrices{i}{1:m}.MatrixQ));   % take the maximum size of MatrixQ of all runs for this subject and put it into l

for run = 1: m ;                     % vom ersten Run bis zum Ende der Anzahl von Runs von einem Probanden
